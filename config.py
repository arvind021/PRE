...
# ✅ Fix: Public links use karo, private invite links nahi
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/ShrutiBots")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/ShrutiSupport")
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/")
YOUTUBE = os.getenv("YOUTUBE", "https://youtube.com/")
GITHUB = os.getenv("GITHUB", "https://github.com/arvind021/PRE")

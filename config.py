...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/arvind021/PRE")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/+dZCL9T23szs5MzVl")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/+dZCL9T23szs5MzVl")
INSTAGRAM = os.getenv("INSTAGRAM", "https://t.me/+dZCL9T23szs5MzVl")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/+dZCL9T23szs5MzVl")
GITHUB = os.getenv("GITHUB", "https://t.me/+dZCL9T23szs5MzVl")
DONATE = os.getenv("DONATE", "https://t.me/+dZCL9T23szs5MzVl")
